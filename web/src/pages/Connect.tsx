    ...
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      ...
      <div className="card p-4 space-y-3">
        <div>
          ...
          <p className="text-xs text-ink-500 mt-1">
            Get one at <a className="underline" href="https://www.notion.so/my-integrations" target="_blank" rel="noreferrer">notion.so/my-integrations</a>.
            Then share your target page with the integration (“…” → “Connections” → add the integration).
          </p>
        </div>
      ...
      <div className="text-sm text-ink-500 leading-relaxed">
        ...
        <ol className="list-decimal pl-5 space-y-1">
          <li>Create an internal integration at notion.so/my-integrations. Copy its token.</li>
          <li>Open the Notion page you want to ingest. Click the “…” menu → “Connections” → add your integration. Sub-pages must be shared too if you want them included.</li>
          <li>Paste the token + page URL above and save.</li>
        </ol>
        <p className="mt-3">
          Notion only allows integrations to read pages explicitly shared with them.
          If a child page is not shared, it's reported as <code>skipped</code> in the Ingest view and the job continues.
        </p>
      </div>
    </div>
  );
